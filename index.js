...
express_app.use(csurf()); //Добавлений в isAuthMiddleWare, оскільки шифрований ключ повинен повертатись на сторону клієнта.
...
//Приклад минулої реалізації, до знайомства з роутерами.
